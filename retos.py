...
def cubo(numero):
    ...
    print(f"El resultados del cubo del numero {numero} es {resultado}")
...
def vocales(palabra):
    ...
    for letra in palabra:
        if letra in "aeiouAEIOU":
            count +=1
            print(f"Tiene {count} vocalas la palabra {palabra}")
        else:
            print("No tienes volcales")
...
def  promedio(*args):
    ...
    print(f"El promedio de {args} es {promedio}")

promedio(20,50,40,15,80,75)
...
def iguales(*args):
    if args[-1] == args[0]:
        ...
        print("Es falso no son igauels")

iguales (20,50,60,80,20)
iguales (20,50,60,80,30)

def igualestotal(*args):
    return all(arg == args[0] for arg in args)

print(igualestotal(20, 50, 60, 80, 20))  # False
print(igualestotal(20, 20, 20, 20, 20))  # True
